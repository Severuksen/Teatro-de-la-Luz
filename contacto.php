...
require("/modulos/consulta.php");
 if (isset($_REQUEST["mensaje"])) {
  ...
  $mail->AddAddress("ernestosuareza8@gmail.com", "Ernesto Suárez");
  $mail->IsHTML(true);
...
<title>$disenador</title>
</head>

<body>
<table width='500' height='600' border='0' align='center' background='https://zatgpa.bn1304.livefilestore.com/y3mI7Jq3o79rg7CLnrgeabXXlTlacfUsTPcnBe9wEur9lqrrPR1aqjrRsBwdhFnle70klq-B45pWJXABKaA8Pon6JUEKCUXH8KnDfSfKkVYfjdU1IKbkf7D54UK8ePeauBaSjPpi7oova9tdEAzrNCI7zew7AMeHO7n_bJstZa8hFg?width=500&height=600&cropmode=none'>
  <tbody>
    <tr>
