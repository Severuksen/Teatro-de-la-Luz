(function(c,d){
	c.widget("ui.rotatable",c.ui.mouse,{
		...
		_create:function(){
			var a;
			this.options.handle?a=this.options.handle:(
		...
		performRotation:function(a){
				...
				this.element.css("transform","rotate("+a+"rad)");this.element.css("-moz-transform","rotate("+a+"rad)");
				this.element.css("-webkit-transform","rotate("+a+"rad)");this.element.css("-o-transform","rotate("+a+"rad)")},
		
		getElementOffset:function(){
			this.performRotation(0);
			var a=this.element.offset();
			this.performRotation(this.elementCurrentAngle);return a},
		...
		getRotateAngle:function(a){
			...
			this.options.snap&&(a=a/Math.PI*180,a=Math.round(a/this.options.step)*this.options.step,a=a*Math.PI/180);
			return a},
