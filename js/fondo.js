$(() => {
	...
	setInterval(() => {
		...
		$("#obra").innerHTML = obras[index].pieza;
		$("#autor").innerHTML = obras[index].autor;
		$("#interprete").innerHTML = obras[index].interprete;
		
	}, 10000);

	if (index == 0){
        document.getElementById("obra").innerHTML = obras[index].pieza;
		document.getElementById("autor").innerHTML = obras[index].autor;
		document.getElementById("interprete").innerHTML = obras[index].interprete;
	}
});